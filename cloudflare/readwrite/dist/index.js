...
// keys.json
var keys_default = { keys: [{ alg: "EdDSA", crv: "Ed25519", key_ops: ["verify"], kid: "service-master_202512", kty: "OKP", use: "sig", x: "Up78p8hB-_MJ-A18sLiM6wQlDpAXE3OLdMt-E-qI4c4" }] };
...
async function verifyMasterToken(token) {
  try {
    console.log("aaa", JSON.stringify(keys_default));
